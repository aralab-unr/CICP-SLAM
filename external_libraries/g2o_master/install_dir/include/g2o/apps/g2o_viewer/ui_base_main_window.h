...
public:
    ...
    {
        BaseMainWindow->setWindowTitle(QApplication::translate("BaseMainWindow", "g2o Viewer", Q_NULLPTR));
        actionLoad->setText(QApplication::translate("BaseMainWindow", "Load", Q_NULLPTR));
        actionSave->setText(QApplication::translate("BaseMainWindow", "Save", Q_NULLPTR));
        actionQuit->setText(QApplication::translate("BaseMainWindow", "Quit", Q_NULLPTR));
        actionWhite_Background->setText(QApplication::translate("BaseMainWindow", "White Background", Q_NULLPTR));
        actionDefault_Background->setText(QApplication::translate("BaseMainWindow", "Default Background", Q_NULLPTR));
        actionDump_Images->setText(QApplication::translate("BaseMainWindow", "Dump Images", Q_NULLPTR));
        actionProperties->setText(QApplication::translate("BaseMainWindow", "Draw Options", Q_NULLPTR));
        actionSave_Screenshot->setText(QApplication::translate("BaseMainWindow", "Save Screenshot", Q_NULLPTR));
        actionSave_Viewer_State->setText(QApplication::translate("BaseMainWindow", "Save Viewer State", Q_NULLPTR));
        actionLoad_Viewer_State->setText(QApplication::translate("BaseMainWindow", "Load Viewer State", Q_NULLPTR));
        cbDrawAxis->setText(QApplication::translate("BaseMainWindow", "Draw Axis", Q_NULLPTR));
        label->setText(QApplication::translate("BaseMainWindow", "# Iterations", Q_NULLPTR));
        cbRobustKernel->setText(QApplication::translate("BaseMainWindow", "Robust Kernel", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        cbOnlyLoop->setToolTip(QApplication::translate("BaseMainWindow", "Only apply the robust kernel for loop closures", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        cbOnlyLoop->setText(QApplication::translate("BaseMainWindow", "Non Sequential", Q_NULLPTR));
        label_4->setText(QApplication::translate("BaseMainWindow", "Kernel Width", Q_NULLPTR));
        leKernelWidth->setText(QApplication::translate("BaseMainWindow", "1.0", Q_NULLPTR));
        label_2->setText(QApplication::translate("BaseMainWindow", "Optimizer", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        btnOptimizerParamaters->setToolTip(QApplication::translate("BaseMainWindow", "Adjust the parameters of the optimizer", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        btnOptimizerParamaters->setText(QApplication::translate("BaseMainWindow", "Parameters", Q_NULLPTR));
        cbxIniitialGuessMethod->clear();
        cbxIniitialGuessMethod->insertItems(0, QStringList()
         << QApplication::translate("BaseMainWindow", "Spanning Tree", Q_NULLPTR)
         << QApplication::translate("BaseMainWindow", "Odometry", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        cbxIniitialGuessMethod->setToolTip(QApplication::translate("BaseMainWindow", "Which method is applied to compute the initial guess", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        btnInitialGuess->setText(QApplication::translate("BaseMainWindow", "Initial Guess", Q_NULLPTR));
        btnReload->setText(QApplication::translate("BaseMainWindow", "Reload", Q_NULLPTR));
        btnSetZero->setText(QApplication::translate("BaseMainWindow", "SetZero", Q_NULLPTR));
        btnOptimize->setText(QApplication::translate("BaseMainWindow", "Optimize", Q_NULLPTR));
        btnForceStop->setText(QApplication::translate("BaseMainWindow", "Stop", Q_NULLPTR));
        btnQuit->setText(QApplication::translate("BaseMainWindow", "Quit", Q_NULLPTR));
        menuFile->setTitle(QApplication::translate("BaseMainWindow", "File", Q_NULLPTR));
        menuView->setTitle(QApplication::translate("BaseMainWindow", "View", Q_NULLPTR));
    } // retranslateUi
